    ...
    <div>
      ...
      <div className="leftside">
        <p className="directions">
          DIRECTIONS: <br />
          Your goal is click each image just once! But every time you click one
          the images will randomly shuffle spots. Good Luck!
        </p>
      </div>
      ...
      <div className="wrapper">
        <div className="container">
          <div>
            <img
              className={`${squares[0]} ${image}`}
              onClick={shiftSquares}
              src={pics[squares[0]]}
              height="400"
              width="180"
              alt="img1"
